...
* If the video player resets after reaching the end, or for any other reason, it now correctly starts at the configured start time for the video, not 00:00:00. B(LD659)
